...
def get_dataset(dataset_name):
    ...
    if dataset_name == "tapex_pretraining":
        ...
        ds = load_dataset("kpriyanshu256/MultiTabQA-tapex-Salesforce-codet5-base-html", streaming=True)
        train_set =  ds['train']
    ...
    # pre-trainng stage 2 + 3
        ...
        train_set = load_dataset(f"kpriyanshu256/MultiTabQA-multitable_pretraining-Salesforce-codet5-base_train-{args.table_type}-combined")['train']
        valid_set = load_dataset(f"kpriyanshu256/MultiTabQA-multitable_pretraining-Salesforce-codet5-base_valid-{args.table_type}-0")['train']
        test_set = None
...
# steps = {
#     'tapex_pretraining': 1650977*2, # 2 epochs # validation = 183442
#     'multitable_pretraining': 121461 * 30, # 30 epochs \\\ 137500
#     'atis': 384 * 60, # 60 epochs
# }

# save_steps = {
#     'tapex_pretraining': 100,
#     'multitable_pretraining': 100,
#     'atis': 20,
...
if args.dataset_name in ['tapex_pretraining']:
    valid_dataset = valid_dataset.take(500)
    print("Using reduced valid dataset")
    print(valid_dataset)

# train_dataset = train_dataset.map(tokenize_batch, batched=True, batch_size=4)
# valid_dataset = valid_dataset.map(tokenize_batch, batched=True, batch_size=4)
...
train_args = Seq2SeqTrainingArguments(
    ...
    # max_steps=steps[args.dataset_name]//(args.gradient_accumulation_steps * args.train_batch_size),
    seed=seed,
    disable_tqdm=False,
